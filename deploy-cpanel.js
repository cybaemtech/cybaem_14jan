...
// Create uploads directory mapping file
const uploadsDirInfo = `
...
writeFileSync('CPANEL_DEPLOYMENT.md', instructions);
writeFileSync('UPLOADS_MAPPING.md', uploadsDirInfo);

console.log('✅ Created deployment instruction files:');
console.log('   - CPANEL_DEPLOYMENT.md');
console.log('   - UPLOADS_MAPPING.md');